...
@Slf4j  //로그 출력 기능이 필요할 때 사용하는 어노테이션임
public class CustomLogoutHandler implements LogoutHandler {
    ...
    //의존성 주입을 위한 생성자
    public CustomLogoutHandler(JWTUtil jwtUtil, MemberService memberService, RefreshTokenService refreshTokenService) {
        ...
        if (authorization != null && authorization.startsWith("Bearer ")) {
            ...
            if (member != null) {
                ...
                if (refresh.isPresent()) {
                    ...
                    refreshTokenService.deleteByRefresh(refreshToken.getTokenValue());
                }
            }
        }
