...
# import 디렉토리명.파일명 => 다른 디렉토리의 파일을 불러 들을 때

# import test_dict.dict_sample
# 모듈명이 길거나 복잡하면 줄임말을 지정할 수도 있음
# import 모듈명 as 줄임말
import test_dict.dict_sample as ts
import mission.dict_mission1 as dm1
import mission.dict_mission2 as dm2
import test_set.set_sample as tests
