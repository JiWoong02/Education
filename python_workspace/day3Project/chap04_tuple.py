...
tp_5 = (1, 'asd', [1,2,3], (4,5,6))
print(tp_5, type(tp_5))

# 튜플 생성시 저장 데이터가 1개일 때는 소괄호 생략호도 됨
tp_6 = 1,
print(tp_6,type(tp_6))

tp_7 = 1,2,3,4
print(tp_7, type(tp_7))
...
# find_index2 = tpl.index('55')
# print('tpl 에 저장된 55의 위치 : ', find_index2)   # error
