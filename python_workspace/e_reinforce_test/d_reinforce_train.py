...
def main():
    ...
    config = {
        ...
        "learning_rate": 0.0007,                    # 학습율   // 0.0009   => 0.001  => 0.0015 => 0.0015 => 0.0007 => 0.0003 => 0.006     !!! 0.0007
        "gamma": 0.86,                              # 감가율    // 0.99    => 0.93 => 0.93 => 0.89 => 0.87 => 0.92 => 0.92    !!! 0.86
...
if __name__ == '__main__':
    wandb.login(key='7774a9331e8286ba4d742da02bea8d3f478e09f4')
    # wandb 프로젝트 초기화
    wandb.init(project="e_dqn_test")
    main()
