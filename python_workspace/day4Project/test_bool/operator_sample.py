...
def func_bool2():
    ...
    # 값이 저장되어 있는, 비어 있는지 확인하는 용도로 사용할 수 있음
    print('result3 : ', bool({'a':1, 'b':2}))  # True
    print('result4 : ', bool({}))   # False
    print('result5 : ', bool([1,2,3,4]))  #True
    print('result6 : ', bool([]))

    print('result7 : ', bool((1,2,3)))
    print('result8 : ', bool())
    # 숫자의 경우 0을 제외한 모든 값은 참이다
    print('result9 : ', bool(123))  # True
    print('result10 : ', bool(1-1)) # False
    print('result11 : ', bool(0))   #False
    print('result12 : ', bool(100*0)) #False
    print('빈괄호 자료형 테스트 ',type({}))
...
def func_logical():
    ...
    print(a==0 and b!=1)  #False or True => True
