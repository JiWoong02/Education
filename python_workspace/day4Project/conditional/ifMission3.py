...
'''
def practice3() :
    tno = input('수험번호를 입력해주세요 : ')
    database = int(input('데이터베이스과목 점수를 입력해주세요 : '))
    program = int(input('프로그래밍언어과목 점수를 입력해주세요 : '))
    software = int(input('소프트웨어공학과목 점수를 입력해주세요 : '))

    if(database>=40 and program>=40 and software>=40 and (database+program+software)>=60) :
