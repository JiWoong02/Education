...
def test_fonts():
    ...
    # D:\python_workspace\visualizationProject2\.venv\Lib\site-packages\matplotlib\mpl-data\fonts\ttf
    # ttf 폴더 안에 다운받은 글꼴 파일을 복사해 넣음
    # 참고 : 압축 푼 ttf 파일을 더블 클릭해서 설치버튼 누르고 설치를 한 경우에는
    #       C:\\windows\\fonts에 기본 설치됨
    ...
    #     => 이전 폰트리스트 정보를 가진 캐시임
    # 3. 프로그램 다시 실행(shift + F10)하면 캐시 파일  생김 > 파일 탐색기
