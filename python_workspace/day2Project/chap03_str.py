...
# 슬라이싱과 연결연산(+)을 혼합해서 사용가능함
n1 = 'abcdef'
n2 = '12345'
n3 = n1[0:3] + n2[1:]   #abc2345  시작인덱스 생략되면 0 끝 인덱스 생략되면 끝까지를 의미함
print(n3)   # abc2345
...
tt = 'apple'
print(tt)
# 파이썬에서는 기록된 문자값은 변결할 수 없음
print(tt.capitalize()) # 첫글자만 대문자
# tt[1] = 'b' # error
...
tt3 = 'tEst stR pyTHOn'
print('tt3 : ',tt3)
print('swapcase : ',tt3.swapcase())   # 소문자는 대문자로, 대문자는 소문자로 변환 함수
print('capitalize : ',tt3.capitalize())     # 문장의 첫글자를 대문자로 변환, 나머지는 소문자로 처리

# title() : 각 단어의 첫글자를 대문자로 변환
print('title : ',tt3.title())
...
print(tt5[tt5.index('e')])

print('find : ', tt5.find('e'))        # 찻아낸 문자의 인덱스
print('find : ', tt5.find('z'))         # 없는 문자 조회시에는 -1 리턴
