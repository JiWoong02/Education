...
#print('{1}학년 {2}반 {3}번 {0}의 점수는{4:.2f}입니다.'.format(name, grade, s_class, s_no, score))
#방법 2
#student_list=[input('학생이름 : '),int(input('학년 : ')),int(input('반 : ')),int(input('번호 : ')),float(input('점수 : '))]
#print(f'{student_list[1]}학년 {student_list[2]}반 {student_list[3]}번 {student_list[0]}의 점수는{student_list[-1]:.2f} 입니다.')
#방법 3
# name = input('학생이름 : ')
# grade = int(input('학년 : '))
# s_class = int(input('반 : '))
