...
# 0 ~ 4 까지의 값을 생성해서 5개를 추출 (중복 선택 안됨)
print(ch1)
print(type(ch1))

ch2 = np.random.choice(5, 3, replace=False)  # suffle 과 같음
# 0 ~ 4 까지의 값을 생성해서 3개를 추출 (중복 선택 안됨)
print(ch2)
print(type(ch2))

ch3 = np.random.choice(5, 10) # shuffle 과 같음   # Default : True
# 0 ~ 4 까지의 값을 생성해서 10개를 추출 (중복 선택 가능)
print(ch3)
print(type(ch3))

ch4 = np.random.choice(5, 10, p=[0.1, 0, 0.3, 0.6, 0]) # shuffle 과 같음   # Default : True
# 0 ~ 4 까지의 값을 생성해서 10개를 추출 (중복 선택 가능)
...
# randn(갯수)
# 기대값이 0이고 표준편차가 1인 표준편차
r3 = np.random.randn(10) # 1차원 배열 10개
print(type(r3))
print(r3)
print(r3.shape)

r4 = np.random.randn(3,5) # 2차원 배열로 3행 5열로 15개
print(type(r4))
print(r4)
print(r4.shape)
...
r5 = np.random.randint(10, size=10) # 0~10 사이의 정수 10개
print(r5)

r6 = np.random.randint(10, 20, 10) # 10~20 사이의 정수 10개
print(r6)

r7 = np.random.randint(10, 20, (3, 5)) # 10~20 사이의 정수 15개 발생, 2차원 배열로 3행 5열
print(r7)