...
public class SecurityConfig {
    ...
    public SecurityConfig(AuthenticationConfiguration authenticationConfiguration, RefreshService refreshService, MemberService memberService, JWTUtil jwtUtil) {
